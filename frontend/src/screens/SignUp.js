...
export default function Signup() {
    ...
    const handleClick = async (e) => {
        ...
        setCredentials({ ...credentials, [e.target.name]: location })
            ...
            // If there's a geolocation error or fetch fails
        ...
        <div style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/images/signup2.jpg)`, backgroundSize: 'cover', height: '100vh' }}>
            ...
            <div className='container' style={{ paddingTop: '100px' }}>
                <form className='w-50 m-auto border bg-dark border-success rounded' onSubmit={handleSubmit}>
                    <span className='text-white mt-2' style={{ fontSize: '32px', fontWeight: 'bold', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>Sign Up</span>
                    <div className="m-3">
